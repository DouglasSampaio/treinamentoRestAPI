...
public class CartaoRefeicao extends Cartao {
    ...
    public CartaoRefeicao(String id, String numero, String titular, String dataValidade, int codigoSeguranca, String senha, double saldo) {
    ...
    public void realizarCompra(double valor) {
        if (saldo >= valor) {
            saldo -= valor;
            System.out.println("Compra realizada com sucesso com o cartão de refeição " + getNumero());
        } else {
